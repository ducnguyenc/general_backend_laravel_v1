...
class RegisterTest extends TestCase
{
    ...
    public function provideInvalidName()
    {
        return [
            ...
            'Name is limit to 255 chars' => ['name', str_repeat('a', 256), 'The name must not be greater than 255 characters.'],
        ];
    }
    ...
    public function provideInvalidPassword()
    {
        return [
            ...
            'Password is min 8 chars' => ['password', str_repeat('a', 7), 'The password must be at least 8 characters.'],
            'Password is limit to 255 chars' => ['password', str_repeat('a', 256), 'The password must not be greater than 255 characters.'],
            'Password is not match confirmation' => ['password', str_repeat('a', 8), 'The password confirmation does not match.'],
        ];
    }
}
